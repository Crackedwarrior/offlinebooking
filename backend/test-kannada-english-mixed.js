...
function createPDFTicket(ticketData) {
  ...
  const outputFilePath = path.join(__dirname, 'temp', `test_kannada_english_${Date.now()}.pdf`);
  ...
  // Try to use Nudi font for Kannada text
  try {
  ...
  try {
    doc.fontSize(10).font('C:\\Windows\\Fonts\\Nudi 01 e.ttf');
  } catch (e) {
  ...
  try {
    doc.fontSize(12).font('C:\\Windows\\Fonts\\Nudi 01 e.ttf');
  } catch (e) {
  ...
  try {
    doc.fontSize(8).font('C:\\Windows\\Fonts\\Nudi 01 e.ttf');
  } catch (e) {
  ...
  try {
    doc.fontSize(14).font('C:\\Windows\\Fonts\\Nudi 01 e.ttf');
  } catch (e) {
  ...
  try {
    doc.fontSize(7).font('C:\\Windows\\Fonts\\Nudi 01 e.ttf');
  } catch (e) {
  ...
  console.log('Mixed Kannada-English ticket created');
  console.log('Kannada text: Theater name, date, movie, class, tax breakdown, total');
  console.log('English text: Ticket ID, seat numbers, GSTIN, time');
}
