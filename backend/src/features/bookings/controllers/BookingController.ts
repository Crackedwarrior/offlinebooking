...
const logger = Logger.withContext('controllers/BookingController');
...
export class BookingController {
  ...
  async getAll(req: Request, res: Response): Promise<void> {
    ...
    logger.debug('GET /api/bookings called', { date, show, status }, req.requestId);
  ...
  async update(req: Request, res: Response): Promise<void> {
    ...
    logger.debug('Updating booking', { id, updateData }, req.requestId);
  ...
  async markPrinted(req: Request, res: Response): Promise<void> {
    ...
    logger.debug('Marking booking as printed', { id }, req.requestId);
    ...
    try {
      ...
      logger.error('Failed to mark booking as printed', {
        error: error instanceof Error ? error.message : 'Unknown error',
        bookingId: id
      }, req.requestId);
  ...
  async delete(req: Request, res: Response): Promise<void> {
    ...
    logger.debug('Deleting booking', { id }, req.requestId);
