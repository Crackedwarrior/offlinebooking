...
export class EscposPrintService {
  ...
  private static createSimpleFormattedTicket(ticketData: any): string {
    ...
    ticket += centerText(getTheaterConfig().name) + '\n';
    ticket += centerText(getTheaterConfig().location) + '\n';
    ticket += '='.repeat(maxWidth) + '\n';
  ...
  private static createEscposCommands(ticketData: any): Buffer {
  ...
  private static createFormattedTicket(ticketData: any): string {
    ...
    formatted += centerText(ticketData.theaterName || getTheaterConfig().name) + '\n';
    formatted += centerText(ticketData.location || getTheaterConfig().location) + '\n';
    formatted += doubleLine + '\n';
  ...
  private static convertEscposToPlainText(escposData: string): string {
