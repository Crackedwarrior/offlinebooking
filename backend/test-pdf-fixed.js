// Test PDF printing (like browser Ctrl+P) - FIXED VERSION
...
async function testPdfFixed() {
  console.log('🖨️ Testing PDF Printing (Browser-style) - FIXED...\n');
  ...
  try {
    ...
    // Generate PDF with proper thermal printer settings (FIXED PARAMETERS)
