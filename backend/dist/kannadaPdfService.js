...
class KannadaPdfService {
    ...
    async createPDFTicket(ticketData) {
        ...
        // Generate PDF
        const outputPath = path_1.default.join(this.tempDir, `kannada_ticket_${Date.now()}.pdf`);
        await page.pdf({
            path: outputPath,
            width: '320px',
            height: '1500px',
    ...
    formatTicket(ticketData) {
        ...
        let cgst = '11.44';
        let sgst = '11.44';
        let ticketId = ticketIdService_1.default.getNextTicketId();
    ...
    translateClassToKannada(englishClass) {
        const translations = {
            'BOX': 'ಬಾಕ್ಸ್',
            'STAR': 'ಸ್ಟಾರ್',
...
exports.default = KannadaPdfService;
