    ...
    <div className="bg-white rounded-lg shadow-sm border p-6">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-amber-800">Family Seating Policy</h3>
            <div className="mt-1 text-sm text-amber-700">
              <p>Theatres are usually visited by families, so we do not want them separated. Our system automatically selects contiguous seats to keep families together.</p>
            </div>
          </div>
        </div>
      </div>
