...
const TicketPrint: React.FC<TicketPrintProps> = ({ 
  ...
  return (
    <PrintErrorBoundary>
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 w-80 relative flex flex-col h-full" style={{ padding: '8px 8px -8px 8px' }}>
          ...
          return (
              ...
              >
                ...
                <div className="flex items-center justify-between w-full">
                  <div className="font-semibold text-base leading-tight text-gray-900">
      ...
      {/* Total and Delete button aligned in same container */}
      <div className="relative w-full">
        <div className="absolute flex items-center gap-4 bg-white rounded-lg px-4 py-3 shadow-sm border border-gray-200" style={{ top: '-85px', right: '20px' }}>
          {/* Total section */}
          ...
          {/* Delete button */}
          <button
            className="bg-red-500 hover:bg-red-600 text-white font-medium px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 text-sm"
          onClick={async () => {
      ...
      <div className="w-full h-32 flex flex-col relative overflow-visible">
